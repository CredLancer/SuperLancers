...
export const GigListing = ({
  ...
  return (
    <Link href={`/gigs/${id}`}>
      <div className="w-100 bg-neutral-900 text-white rounded p-10 mt-4 hover:opacity-50 hover:cursor-pointer flex flex-wrap justify-between border-2" style={{ borderColor: `${statecolor[status]}` }}>
