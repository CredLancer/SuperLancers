...
export const PaginationButton = ({ currentPage, totalItems, setCurrentPage }: PaginationButtonProps) => {
  ...
  const prevButtonClass = isPrevButtonDisabled ? "bg-neutral-200 cursor-default" : "btn btn-primary";
  const nextButtonClass = isNextButtonDisabled ? "bg-neutral-200 cursor-default" : "btn btn-primary";
